package com.example.user.gamelanbekonang.adapter;
...
import com.example.user.gamelanbekonang.menuHome.DetailIklanActivity;
...
//        holder.tvGambarUser.setText(iklan.getUser_image());
            Picasso.get()
                    .load("http://bekonang-store.000webhostapp.com/images/"+iklan.getImage())
                    .error(R.mipmap.ic_launcher)
                    .into(holder.ivGambar);

            Picasso.get()
                    .load("http://bekonang-store.000webhostapp.com/images/"+iklan.getUser_image())
                    .centerCrop()
                    .resize(600, 800)
                    .error(R.mipmap.ic_launcher)
